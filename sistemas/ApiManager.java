...
public class ApiManager
{
    ...
    public static void ItemServer(final Player p) {
    	...
    	darItem(p, Material.STAINED_GLASS_PANE, 1, "§7VIDRO", 0);
    	darItemBussola(p, Material.COMPASS, 1, "§eWarps §7(Clique)", 1);
        darItem(p, Material.STAINED_GLASS_PANE, 1, "§7VIDRO", 2);
     
        darItem(p, Material.ENDER_CHEST, 1, "§eCaixa §7(Clique)", 3);
        darItem(p, Material.STAINED_GLASS_PANE, 1, "§7VIDRO", 4);
        darItem(p, Material.CHEST, 1, "§eKits §7(Clique)", 5);
        darItem(p, Material.STAINED_GLASS_PANE, 1, "§7VIDRO", 6);
        darItem(p, Material.GOLD_INGOT, 1, "§eLojas §7(Clique)", 7);
        darItem(p, Material.STAINED_GLASS_PANE, 1, "§7VIDRO", 8);
